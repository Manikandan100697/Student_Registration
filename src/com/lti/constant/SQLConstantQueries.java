...
public class SQLConstantQueries {
	...
	public static final String ADD_COURSES="INSERT INTO register_courses VALUES (?,?)";
	
	public static final String DROP_COURSE="DELETE FROM register_courses WHERE StudentID=? AND CourseID=?" ;
	
	public static final String VIEW_SELECTED_COURSES="SELECT course.CourseID, course.CourseTitle, course.Credits\r\n" + 
			"FROM course \r\n" + "INNER JOIN register_courses \r\n" + "ON register_courses.CourseID = course.CourseID\r\n" + "WHERE register_courses.StudentID= ?";
	...
	public static final String UPLOAD_GRADES="INSERT INTO grade VALUES (?,?,?)";
...
//	
	public static final String NUMBER_OF_COURSES_SELECTED="SELECT count(CourseID) FROM register_courses WHERE StudentID=?";
//
	public static final String UPDATE_REGISTARTION_STATUS="UPDATE student SET StudentRegistrationStatus= true WHERE StudentID=?";
	
	public static final String REGISTRATION_OF_COURSES= "UPDATE register_courses SET CourseRegistrationStatus=1 WHERE STUDENTID=?";
//	
	public static final String REGISTRATION_OF_COURSE= "INSERT INTO registration VALUES (?,?,?,?,CURRENT_TIMESTAMP)";
//	
	public static final String UPDATE_ENROLLED_STUDENTS_NUMBER="UPDATE course_inventory SET NumberOfStudentsEnrolled = NumberOfStudentsEnrolled +1 WHERE CourseID IN (SELECT CourseID FROM register_courses WHERE StudentID=? AND CourseRegistrationStatus= true)";
//
